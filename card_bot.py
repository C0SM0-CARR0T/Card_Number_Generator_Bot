...
bot = TeleBot(token='5520896950:AAG7WdLN5O22ox72qx1Sktnz_ih4n8xGEV8', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Hello, friend! I can generate test bank card number\nMake your choice😎:', # текст сообщения
...
def message_handler(message: types.Message):
    ...
    if message.text == 'VISA':
        ...
        bot.send_message(
            ...
            text='Sorry, I do not understand you☠️, try again',
        )
        return
